    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                <h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2">TUTOR REGISTRATION</h2>
                ...
                <form action="TutorServlet" method = "POST" class="mbr-form form-with-styler">
                    ...
                    <div class="dragArea row">
                        ...
                        <div class="col-md-6  form-group" data-for="availability">
                            ...
                            <input type="text" name="availability" data-form-field="Availability" class="form-control display-7" id="availability-form1-17">
                        </div>
                        
                        <div data-for="subject" class="col-md-6 form-group">
                        ...
                        <div data-for="description" class="col-md-12 form-group">
                            ...
                            <textarea name="description" data-form-field="Message" class="form-control display-7" placeholder="Please include relevent qualifications and experience." id="description-form1-17"></textarea>
