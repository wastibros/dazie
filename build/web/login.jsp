...
<section class="engine"><a href="https://mobirise.info/r">bootstrap templates</a></section><section class="mbr-section form1 cid-rFPtFNl5dj" id="form1-b">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                <!---Formbuilder Form--->
                <form action="LoginServlet" method="POST" class="mbr-form form-with-styler">
                    <div class="row">
                    ...
                    <div class="dragArea row">
                        <div class="col-md-6  form-group" data-for="name">
                            <label for="name-form1-b" class="form-control-label mbr-fonts-style display-7">Email</label>
                            <input type="email" name="email" data-form-field="Name" required="required" class="form-control display-7" id="name-form1-b">
                        </div>
                        
                        <div data-for="phone" class="col-md-6  form-group">
                            <label for="phone-form1-b" class="form-control-label mbr-fonts-style display-7">Password</label>
                            <input type="text" name="password" data-form-field="Password" class="form-control display-7" id="phone-form1-b">
                        </div>
                        <div data-for="type" class="col-md-12 form-group">
                            <label for="type-form1-" class="form-control-label mbr-fonts-style display-7">User</label>
