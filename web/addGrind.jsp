...
<section class="engine"><a href="https://mobirise.info/t">free amp template</a></section><section class="mbr-section form1 cid-rHHycMDcNQ" id="form1-17">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                <h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2">Add Group Grind</h2>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                ...
                <form action="GrindServlet" method = "post" class="mbr-form form-with-styler">
                    <div class="row">
...
>>>>>>> 095e8ef28b8c2a4b507f1b2d158a76cdb7a506bd
                        ...
                        <div data-for="location" class="col-md-4 form-group">
                            ...
                            <div data-for="glocation" class="col-md-4  form-group">
                            <label for="glocation-form1-i" class="form-control-label mbr-fonts-style display-7">Building</label>
                            <input type="text" name="glocation" data-form-field="Glocation" class="form-control display-7" id="password-form1-i">
                        </div>
                           
                        <div class="col-md-4  form-group" data-for="date">
                            <label for="date-form1-17" class="form-control-label mbr-fonts-style display-7">Date</label>
                            <input type="text" name="date" data-form-field="Date" class="form-control display-7" placeholder="DD/MM/YY" id="availability-form1-17">
                        </div>
                        
                            <div class="col-md-4  form-group" data-for="time">
                            <label for="time-form1-17" class="form-control-label mbr-fonts-style display-7">Time</label>
                            <input type="text" name="time" data-form-field="Time" required="required" class="form-control display-7" placeholder="00:00" id="email-form1-17">
                        </div>
                            
                        <div class="col-md-4  form-group" data-for="price">
                            <label for="price-form1-17" class="form-control-label mbr-fonts-style display-7">Price</label>
                            <input type="text" name="price" data-form-field="Price" required="required" class="form-control display-7" id="email-form1-17">
                        </div>
                            
                            <div class="col-md-4  form-group" data-for="capacity">
                            <label for="time-form1-17" class="form-control-label mbr-fonts-style display-7">Capacity</label>
                            <input type="text" name="capacity" data-form-field="Capacity" required="required" class="form-control display-7" id="email-form1-17">
                        </div>
                            
                        </div>
                        <div class="col-md-12 input-group-btn align-center"><button type="submit" value="Submit" class="btn btn-primary btn-form display-4">Add Group Class</button></div>
...
<section once="footers" class="cid-rFTzwXlkTi" id="footer7-16">
