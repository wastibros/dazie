...
<body>
  <section class="menu cid-rIcIgeJgqe" once="menu" id="menu1-1h">
...
<section class="engine"><a href="https://mobirise.info/t">free amp template</a></section><section class="mbr-section form1 cid-rIcIgfXy77" id="form1-1i">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                <h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2">ACCOUNT</h2>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                <!---Formbuilder Form--->
                <%
                    Student student = StudentDbManager.getStudentInformation(session.getAttribute("email").toString());
                %>
                <form action="StudentServlet" method="POST" class="mbr-form form-with-styler">
                    ...
                    <div class="dragArea row">
                        <div class="col-md-4  form-group" data-for="name">
                            ...
                            <input type="text" name="name" data-form-field="Name" required="required" class="form-control display-7" id="name-form1-1i" value="<%=student.getName()%>">
                        </div>
                        <div class="col-md-4  form-group" data-for="email">
                            <label for="email-form1-1i" class="form-control-label mbr-fonts-style display-7">Email</label>
                            <input  value="<%=student.getEmail()%>" type="email" name="email" data-form-field="Email" required="required" class="form-control display-7" id="email-form1-1i">
                        </div>
                        <div data-for="phone" class="col-md-4  form-group">
                            <label for="phone-form1-1i" class="form-control-label mbr-fonts-style display-7">Password</label>
                            <input  value="<%=student.getPassword()%>" type="text" name="password" data-form-field="Phone" class="form-control display-7" id="phone-form1-1i">
                        </div>
                            ...
                            <select class="form-control" name="location">
                                <%
                                    ...
                                    for(Location location:list){
                                        if(location.getLocationId() == student.getLocationId()){
                        ...
                        <div data-for="message" class="col-md-12 form-group">
                            <label for="message-form1-1i" class="form-control-label mbr-fonts-style display-7">Description</label>
                            <textarea  name="description" data-form-field="Message" class="form-control display-7" id="message-form1-1i"><%=student.getDescription()%></textarea>
                        </div>
...
<section once="footers" class="cid-rIcIghATSy" id="footer7-1j">
